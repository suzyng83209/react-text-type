...
exports.Container = exports.BlinkingCaret = undefined;
...
var BlinkingCaret = exports.BlinkingCaret = _styledComponents2.default.span(_templateObject, function (props) {
    return props.isBlink ? 'initial' : 'transparent';
}, function (props) {
    return props.last ? '8px' : '0';
});

var Container = exports.Container = _styledComponents2.default.div(_templateObject2, function (props) {
    return props.size || '4em';
});
...
var Typewriter = function (_React$PureComponent) {
    ...
    function Typewriter(props) {
        ...
        _this.tick = function () {
            if (_this.state.counter < (_this.state.letters || []).length) {
        ...
        _this.handleBlink = function () {
            if ((_this.state.letters || []).length) {
                _this.setState(function (prevState) {
                    return { isBlink: !prevState.isBlink };
                });
            }
        };

        _this.state = {
            letters: [].concat(_toConsumableArray(props.phrase)),
    ...
    _createClass(Typewriter, [{
        ...
        value: function componentDidMount() {
            ...
            var _props = this.props,
                delay = _props.delay,
                typingSpeed = _props.typingSpeed,
                blinkDuration = _props.blinkDuration;

            setTimeout(function () {
                return _this2.setState({
                    typingTimer: setInterval(_this2.tick, typingSpeed),
                    blinkingCaretTimer: setInterval(_this2.handleBlink, blinkDuration)
                });
            }, delay);
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                letters.map(function (x, i) {
                    return i < counter && i < letters.length && _react2.default.createElement(
                        _components.BlinkingCaret,
                        {
                            key: i,
...
Typewriter.propTypes = {
    ...
    typingSpeed: _propTypes2.default.number,
    blinkDuration: _propTypes2.default.number,
    sustained: _propTypes2.default.bool
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object__ = __webpack_require__(10);
